...
class CGANTrainer(object):
    ...
    def G_trainstep(self, x_fake, x_real):
        ...
        if self.gan_algo in ('TimeGAN', 'FTimeGAN'):
    ...
    def compute_loss(self, d_out, target):
        ...
        if self.gan_algo in ['RCGAN', 'TimeGAN', 'FTimeGAN', 'ECTimeGAN']:
...
class GAN(BaseAlgo):
    def __init__(self, base_config, gan_algo, x_real):
        ...
        self.G_optimizer = torch.optim.Adam(self.G.parameters(), lr=1e-4, betas=(0.0, 0.9))
